...
class TestTransformers(TestCase):
    ...
    def test_argparse2class(self) -> None:
        ...
        """
        run_ast_test(self,
                     ArgparseTransform(argparse_func_ast,
                                       inline_types=False,
                                       emit_default_doc=True).to_class(),
                     gold=class_ast)
    ...
    def test_class2argparse(self) -> None:
        ...
        """
        run_ast_test(self,
                     ClassTransform(class_ast,
                                    inline_types=True,
                                    emit_default_doc=False).to_argparse(),
    ...
    def test_docstring2class(self) -> None:
        ...
        """
        run_ast_test(self,
                     DocstringTransform(docstring_str,
                                        inline_types=True,
                                        emit_default_doc=True).to_class(),
                     gold=class_ast)
    ...
    def test_class2docstring(self) -> None:
        ...
        """
        self.assertEqual(ClassTransform(class_ast,
                                        inline_types=True,
                                        emit_default_doc=False).to_docstring(),
                         docstring_str)
    ...
    def test_docstring2function(self) -> None:
        ...
        run_ast_test(
            ...
            DocstringTransform(docstring_str,
                               inline_types=True,
                               emit_default_doc=False).to_function('method_name', function_type='self'),
            gold=next(
                node
