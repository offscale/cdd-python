...
from ast import ClassDef, Name, Load, Expr, Constant, AnnAssign, \
    Subscript, Store, Dict, Tuple, Attribute, Index, arguments, FunctionDef, \
    arg, Assign, Call, keyword, Return
...
class_ast = ClassDef(bases=[Name(ctx=Load(),
                                 id='object')],
    ...
    body=[
        Expr(value=Constant(kind=None,
                            value='\n    Set CLI arguments\n\n    '
                                  ...
                                  ' Tuple[np.ndarray, np.ndarray]]]```\n    ')),
        Assign(
            targets=[Attribute(attr='description',
                               ctx=Store(),
                               value=Name(ctx=Load(),
                                          id='argument_parser'))],
            type_comment=None,
            value=Constant(kind=None,
                           value='Acquire from the official tensorflow_datasets model zoo, or the'
