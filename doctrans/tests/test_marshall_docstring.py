...
class TestMarshallDocstring(TestCase):
    ...
    def test_docstring_line_parsing(self) -> None:
        ...
        for line in lines:
            default = _parse_line(line, 'foo', default, docs, typ, emit_default_doc=True)
        self.assertIsNone(default)
        self.assertListEqual(docs, [':param foo: bar', ' additional description', 'type foo: str'])
        ...
        self.assertListEqual(typ, ['append_here', ':param foo: bar', ' additional description', 'type foo: str'])
