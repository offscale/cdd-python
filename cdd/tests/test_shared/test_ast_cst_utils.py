...
from cdd.shared.ast_cst_utils import (
    Delta,
    debug_doctrans,
    find_cst_at_ast,
...
from cdd.shared.pure_utils import identity, rpartial
...
class TestAstCstUtils(TestCase):
    ...
    def test_find_cst_at_ast_errors_on_module(self) -> None:
        ...
        with patch("cdd.shared.ast_cst_utils.stderr", new_callable=StringIO) as e:
    ...
    def test_debug_doctrans(self) -> None:
        ...
        """
        with patch(
            "cdd.shared.ast_cst_utils.print", new_callable=MagicMock()
        ) as print_func:
